...
@Slf4j
@RestController
@RequestMapping("/lich-su-cap-nhat-thanh-vien")
public class LichSuCapNhatThanhVienController {
	
  @Autowired
  private LichSuCapNhatThanhVienService service;


  @PostMapping(value = PathConstant.URL_SEARCH_PAGE, produces = MediaType.APPLICATION_JSON_VALUE)
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> colection(@RequestBody LichSuCapNhatThanhVienReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> colectionList(@RequestBody LichSuCapNhatThanhVienReq objReq) throws Exception {
  ...
  public ResponseEntity<BaseResponse> insert(@Valid @RequestBody LichSuCapNhatThanhVienReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public ResponseEntity<BaseResponse> update(@Valid @RequestBody LichSuCapNhatThanhVienReq objReq) throws Exception {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity<BaseResponse> delete(@Valid @RequestBody LichSuCapNhatThanhVienReq idSearchReq) throws Exception {
